# Project Title
Mobile test Framework for Mobilogy Apps



## Getting Started
after cloning the repo please use below command to run your tests

For Diagnostic Android App on local appium server: 
```
npm run diagnostics:android -- --params.mobile.app=/Path/To/App/Mobilogy_Diagnostics_10037_QA_Signed.apk --params.mobile.deviceName='PoC'  --params.mobile=android
```

For Diagnostic iOS App on local appium server: 
```
npm run diagnostics:iphone -- --params.mobile.app=/Path/To/App/OnlineDiagnostics_Staging.ipa --params.mobile.deviceName='iPhone 7' --params.mobile=ios
```

For Diagnostic Android App on Browser Stack
```
npm run diagnostics:androidBS -- --params.browserstack.user=userName --params.browserstack.key=userKey --params.browserstack.device='Samsung Galaxy S8' --params.browserstack.app=bs://60a8baf5587712adfd1d475048cb74055166e1cc --params.browserstack.automationName=UIAutomator2
```

For Diagnostic iOS App on Browser Stack
```
npm run diagnostics:iphoneBS -- --params.browserstack.user=userName --params.browsstack.key=userKey --params.browserstack.app=bs://621f5529eace6b3b4893561c36137ff0be76ae39 --params.browserstack.automationName=XCUITest

https://github.com/appium/appium-xcuitest-driver/blob/master/docs/real-device-config.md

### Requirments for developing tests for iOS apps
* MacBook, 
* XCode, 
* .ipa file access of the application under test, 
* Appium server running on local, 
* Will not work on Virtual machine, 
...
* All device related helpers should be put under e2e/components/mobile/mobile-helper.ts
* please update 'browserstack.user', 'browserstack.key' & 'app' in protractor.browserstack.conf.js file
